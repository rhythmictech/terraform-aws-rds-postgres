...
| [aws_db_instance.this_ignore_engine_version](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/db_instance) | resource |
...
| <a name="input_ignore_engine_version_change"></a> [ignore\_engine\_version\_change](#input\_ignore\_engine\_version\_change) | Ignore changes to the `var.engine_version` caused by automatic upgrades | `bool` | `true` | no |
